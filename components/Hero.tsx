      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 h-full flex flex-col justify-center items-center">
        <div className="max-w-4xl flex flex-col justify-between gap-6 sm:gap-10">
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl max-w-2xl mx-auto font-bold text-[#0099CC] text-center mb-4 sm:mb-6 leading-tight px-4"
          >
            {title}
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg md:text-xl text-black text-center mb-6 sm:mb-8 leading-relaxed px-4"
          >
            {description}
          </motion.p>
          </div>
          ...
          <motion.div 
            ...
            className="relative group w-full flex justify-center items-center px-4"
          >
            <a
              href={buttonLink}
            ...
            <motion.div 
              ...
              className="hidden sm:flex absolute right-48 md:right-40 lg:right-60 bg-[#FFD700] w-20 h-20 sm:w-28 sm:h-28 rounded-full items-center justify-center transition-transform group-hover:scale-105 pointer-events-none"
            >
